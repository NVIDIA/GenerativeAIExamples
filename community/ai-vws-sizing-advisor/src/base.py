...
class BaseExample(ABC):
    """This class defines the basic structure for building RAG rag server examples.
    All RAG rag server example classes should inherit from this base class and implement the
