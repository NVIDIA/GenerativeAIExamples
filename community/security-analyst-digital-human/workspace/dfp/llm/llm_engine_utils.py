...
def build_engine_llm_service(prompt_template: str, llm_service: str = "NIM", output_column:str = "response"):
    ...
    if llm_service == "NemoLLM":
        ...
        llm_service_cls = NIMChatService #This currently hits build.nvidia.com
        model_name = "meta/llama-3.1-405b-instruct" #To use your NIM, change to "meta/llama3-8b-instruct"
        base_url =  "https://integrate.api.nvidia.com/v1" #To use your NIM change to "http://nim-llm:8000/v1"
    else:
