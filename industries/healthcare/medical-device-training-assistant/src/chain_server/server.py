...
from src.chain_server.tracing import llamaindex_instrumentation_wrapper
...
def import_example() -> None:
    ...
    file_location = os.path.join( os.environ.get("APP_PATH", "./"))
    ...
    raise NotImplementedError(f"Could not find a valid example class in APP_PATH {file_location}")
